...
export const SideBar = () => (
    <VStack pos='fixed' right={0} bottom={0} top={{ base: '64px', xl: '80px' }} w='208px'>
        <VStack spacing='24px' pt='16px'>
            <IconCounter icon={BookmarkHeart} count={185} spacing='8px' padding='8px 16px' />
            <IconCounter icon={People} count={589} spacing='8px' padding='8px 16px' />
            <IconCounter icon={EmojiHeartEyes} count={587} spacing='8px' padding='8px 16px' />
        </VStack>
        <Spacer />
        <Center
            h='208px'
