...
import { NutritionValueItem } from '~/pages/recipesPage/nutritionValue/nutritionValueItem/NutritionValueItem.tsx';
...
export const NutritionValue = ({ nutritionValue }: Props) => {
    ...
    return (
        <Box
            ...
            mt={{ base: 6, xl: 10 }}
        >
            <Text color='blackAlpha.800' fontSize='sm' mb={{ base: 3, '2xl': 5 }}>
