...
export const newRecipesCardsData: NewRecipesCardData[] = [
    {
        ...
        iconCounters: [{ icon: BookmarkHeart, count: 1, spacing: '6px', padding: '4px 8px' }],
    ...
    },
    {
        ...
        iconCounters: [
            { icon: BookmarkHeart, count: 2, spacing: '6px', padding: '4px 8px' },
            { icon: EmojiHeartEyes, count: 1, spacing: '6px', padding: '4px 8px' },
        ],
        tagIcon: Vegan,
    ...
    },
    {
        ...
        iconCounters: [{ icon: EmojiHeartEyes, count: 1, spacing: '6px', padding: '4px 8px' }],
        tagIcon: Desserts,
