...
export const theJuciestPageMainCardsData: MainSectionData[] = [
    {
        ...
        iconCounters: [
            { icon: BookmarkHeart, count: 258, spacing: '6px', padding: '4px' },
            { icon: EmojiHeartEyes, count: 342, spacing: '6px', padding: '4px' },
        ],
    ...
    },
    {
        ...
        text: 'Как раз после праздников, когда мясные продукты еще остались, но никто их уже не хочет, время варить солянку.',
        iconCounters: [
            { icon: BookmarkHeart, count: 124, spacing: '6px', padding: '4px' },
            { icon: EmojiHeartEyes, count: 324, spacing: '6px', padding: '4px' },
        ],
        tagIcon: National,
    ...
    },
    {
        ...
        text: 'Как раз после праздников, когда мясные продукты еще остались, но никто их уже не хочет, время варить солянку.',
        iconCounters: [
            { icon: BookmarkHeart, count: 159, spacing: '6px', padding: '4px' },
            { icon: EmojiHeartEyes, count: 257, spacing: '6px', padding: '4px' },
        ],
        tagIcon: SecondCourses,
        tagTitle: 'Вторые блюда',
        bgColorTag: 'lime.50',
    },
    {
        ...
        text: 'Как раз после праздников, когда мясные продукты еще остались, но никто их уже не хочет, время варить солянку.',
        iconCounters: [
            { icon: BookmarkHeart, count: 85, spacing: '6px', padding: '4px' },
            { icon: EmojiHeartEyes, count: 152, spacing: '6px', padding: '4px' },
        ],
        tagIcon: SecondCourses,
        tagTitle: 'Вторые блюда',
        bgColorTag: 'lime.50',
